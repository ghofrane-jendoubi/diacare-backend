...
public class ReclamationService {
    ...
    public Map<String, Long> getStats() {
        ...
        stats.put("nutritionnist", all.stream().filter(r -> r.getCreatedByRole() == UserRole.NUTRITIONNIST).count());
