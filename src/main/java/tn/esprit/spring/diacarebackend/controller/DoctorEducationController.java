...
public class DoctorEducationController {
    ...
    public ResponseEntity<List<Notification_education>> getNotifications(@PathVariable Long doctorId) {
    ...
    public ResponseEntity<List<Notification_education>> getUnreadNotifications(@PathVariable Long doctorId) {
